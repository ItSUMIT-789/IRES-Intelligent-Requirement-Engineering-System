...
public class DeveloperTask {
    ...
    public DeveloperTask(Project project, Requirement requirement, UserStory userStory, String title,
                         String description, User assignedTo, RequirementPriority priority,
                         TaskStatus status, LocalDate dueDate, User createdBy) {
