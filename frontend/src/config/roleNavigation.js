...
export const ROLE_NAVIGATION = {
  ADMIN: [['overview', 'Dashboard', LayoutDashboard], ['users', 'Users', Users], ['projects', 'Projects', FolderKanban], ['requirements', 'Requirements', FileText], ['workflow', 'Workflow / Assignments', Network], ['tasks', 'Developer Tasks', ListChecks], ['testing', 'Testing', ClipboardCheck], ['bugs', 'Bugs', Bug], ['reports', 'Reports', FileOutput], ['profile', 'Profile', UserCircle]],
